...
const width = 10;
const bgPaths = ["1.png", "2.jpg", "3.jpeg", "4.jpeg"];
const people = {
  0: { name: "Jisna Jose", class: "CS7A" },
  1: { name: "Shimil Abraham", class: "CS3A" },
  2: { name: "Alan Chettan", class: "LKG-B" },
  3: { name: "Jency Chechy", class: "EB5" },
};
let goldValue = 100;
let triesValue = 0;
let index = 0;
...
gameRoundValue.innerText = index + 1;
